...
url = "https://nxs-1.int.ops.cldx.ru/"
host = "nxs-1.int.ops.cldx.ru"
port = 443

# Путь к файлу сертификата
certificate_file = "nxs-1.der"
...
delete_command = f'keytool -delete -alias sslnxs-1 -storepass changeit -keystore "{keystore_path}"'

# Команда для импорта нового сертификата в keystore
import_command = f'keytool -importcert -file "{certificate_file}" -alias sslnxs-1 -storepass changeit -keystore "{keystore_path}"'
