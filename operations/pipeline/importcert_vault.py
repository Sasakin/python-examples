...
url = "https://vault.dev.cldx.ru/"
host = "vault.dev.cldx.ru"
port = 443

# Путь к файлу сертификата
certificate_file = "vault.der"
...
delete_command = f'keytool -delete -alias sslvaultdev -storepass changeit -keystore "{keystore_path}"'

# Команда для импорта нового сертификата в keystore
import_command = f'keytool -importcert -file "{certificate_file}" -alias sslvaultdev -storepass changeit -keystore "{keystore_path}"'
